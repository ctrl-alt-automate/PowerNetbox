#
# Module manifest for module 'NetboxPSv4'
#
...
Copyright = '(c) 2018-2025 Ben Claussen and contributors. Fork maintained by ctrl-alt-automate.'

# Description of the functionality provided by this module
Description = 'NetboxPSv4 - A comprehensive PowerShell module for the Netbox REST API with 100% API coverage. Fork of NetboxPS with full Netbox 4.x compatibility. Supports DCIM, IPAM, Virtualization, Circuits, Tenancy, VPN, Wireless, Extras, Core, and Users modules. Cross-platform (Windows, Linux, macOS).'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = 'Netbox','NetboxPS','NetboxPSv4','NetboxAPI','API','REST','DCIM','IPAM','Infrastructure','Automation','NetworkAutomation','DataCenter','Virtualization','VPN','Wireless','AssetManagement','CrossPlatform','Linux','MacOS','Windows'
