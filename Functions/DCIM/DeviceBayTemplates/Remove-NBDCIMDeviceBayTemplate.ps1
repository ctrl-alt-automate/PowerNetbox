<#
.SYNOPSIS
    Removes a DCIM Device BayTemplate from Netbox DCIM module.
...
.EXAMPLE
    Remove-NBDDCIM Device BayTemplate
...
#>
function Remove-NBDDCIM Device BayTemplate {
    ...
    process {
        Write-Verbose "Removing DCIM DeviceB ay Te mp la te"
